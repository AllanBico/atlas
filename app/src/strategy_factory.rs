use app_config::types::{StrategyConfig, StrategySettings};
use strategies::{Strategy, ma_crossover::MACrossover, supertrend::SuperTrend, prob_reversion::ProbReversion};
